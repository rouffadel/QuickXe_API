...
-- 1. Add CurrencySymbol column to CountriesMaster if it doesn't exist
...
-- 2. Populate CountriesMaster with Currency Symbols based on CountryCode
...
-- 3. Update existing Country table from CountriesMaster
